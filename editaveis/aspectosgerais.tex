...
Aqui está listado  os gastos preliminares de energia, assim como todas as aquisições que serão feitas durante o projeto:
...
\begin{itemize}
	...
	\item RSN 1 - Aproximação de veículos muito próximos, praticamente colados;
