...
\begin{figure}[H]
	\center{\includegraphics[scale=0.5]{caso_de_uso_2.pdf}}
...
\begin{figure}[H]
	\center{\includegraphics[scale=0.4]{caso_de_uso_1.pdf}}
...
As Figuras \ref{fig:rdm-server}, \ref{fig:rdm-cliente} e \ref{fig:explorer-rethinkdb} mostram imagens da execução do serviço \textit{Rethink Data Manager} e do banco de dados \textit{RethinkDB}.\newpage
