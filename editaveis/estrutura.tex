...
2 & Caixa Para Painel Eletrico de Aço – 500x500x250 & R\$ 255,00 & R\$ 510,00 & Nobre Brasil \\ \hline
...
\begin{figure}[H]
	\centering
    \includegraphics[keepaspectratio=true,scale=0.4]{imagens/estruturacompleta.jpeg}
...
\begin{figure}[H]
	\centering
    \includegraphics[keepaspectratio=true,scale=0.4]{imagens/hastes.jpeg}
...
\begin{figure}[H]
	\centering
    \includegraphics[keepaspectratio=true,scale=0.3]{imagens/holofote.jpeg}
    \caption{Modelo do holofote comercial que sinalizará ao motorista}
    \label{holof}
\end{figure}

O painel solar (figura \ref{painelsol}) se encontra logo atrás da caixa superior. Será necessário a construção de um suporte para o mesmo e será soldado a as hastes em 4 pontos com uma angulação de 15 graus como solicitado pelo grupo de energia. 

\begin{figure}[H]
	\centering
    \includegraphics[keepaspectratio=true,scale=0.3]{imagens/painelcomsup.jpeg}
...
\begin{figure}[H]
	\centering
    \includegraphics[keepaspectratio=true,scale=0.3]{imagens/camera.jpeg}
...
\begin{figure}[H]
	\centering
    \includegraphics[keepaspectratio=true,scale=0.3]{imagens/antenaradar.jpeg}
...
\begin{figure}[H]
	\centering
    \includegraphics[keepaspectratio=true,scale=0.3]{imagens/placademontagemcomcomp.jpeg}
...
\begin{figure}[H]
	\centering
    \includegraphics[keepaspectratio=true,scale=0.5]{imagens/eletrodutos.png}
...
\begin{figure}[H]
	\centering
    \includegraphics[keepaspectratio=true,scale=0.5]{imagens/caixa1elet.png}
...
\begin{figure}[H]
	\centering
    \includegraphics[keepaspectratio=true,scale=0.5]{imagens/caixa2elet.png}
