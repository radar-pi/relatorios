...
\includepdf[pages={1},scale=0.75,pagecommand= \section{Códigos Estrutura Estática}\label{codigo_estatico}]{estatico.pdf}
\includepdf[pages={2-},scale=0.8,pagecommand= {}]{estatico.pdf}
\includepdf[pages={1},scale=0.75,pagecommand= \section{Dissipação de calor}\label{codigo_dissipacao}]{dissipacao.pdf}
\includepdf[pages={2},scale=0.8,pagecommand= {}]{dissipacao.pdf}
\includepdf[angle=90,scale=0.75, pagecommand= \section{Desenhos Técnicos apresentados}]{Haste.pdf}
