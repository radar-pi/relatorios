...
\begin{figure}[h]
	\center{\includegraphics[scale=0.5]{Untitled_Diagram-2.png}}
...
\subsubsection{Módulo de reconhecimento do veículo}
 ...
 \begin{figure}[!htb]
	\center{\includegraphics[scale=1]{Processos.pdf}}
...
Na Fig. \ref{fig:nuand}, será apresentado o diagrama de processos entre o \emph{Nuand Blade} e a antena.
 ...
 \begin{figure}[!htb]
	\center{\includegraphics[scale=1]{Processos-2.pdf}}
...
\begin{figure}[!htb]
	\center{\includegraphics[scale=0.35]{bladerf.pdf}}
...
\begin{figure}[!htb]
	\center{\includegraphics[scale=0.5]{nrf24.pdf}}
...
\begin{figure}[!htb]
	\center{\includegraphics[scale=0.5]{gsm.pdf}}
...
A Tabela \ref{tab:app} apresenta as restrições e requisitos para construção do sistema em React-Native.
