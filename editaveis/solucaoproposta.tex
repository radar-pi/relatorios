...
\subsubsection{Definições, Acrônimos e Abreviações}\label{definiuxe7uxf5es-acruxf4nimos-e-abreviauxe7uxf5es}
...
\subsubsection{Servidor de Microserviços RaDop - SMR}\label{servidor-de-microserviuxe7os-radop---smr}
...
\subsection{Requisitos e Restrições Arquiteturais}\label{requisitos-e-restriuxe7uxf5es-arquiteturais}

\subsubsection{Servidor de Microserviços RaDop - SMR}\label{servidor-de-microserviuxe7os-radop---smr-1}
...
\subsubsection{WebApp Dashboard RaDop}\label{webapp-dashboard-radop-1}
...
\subsubsection{Aplicativo RaDop}\label{aplicativo-radop-1}
...
\subsection{Visão Lógica}\label{visuxe3o-luxf3gica}

\subsubsection{Serviços RaDop}\label{serviuxe7os-radop}
...
\subsubsection{WebApp Dashboard RaDop}\label{webapp-dashboard-radop-2}

A visão lógica do WebApp Dashboard está descrita na Figura 2.

\begin{figure}[!htb]
    \center{\includegraphics[width=\textwidth]{diagrama-pacotes-django.eps}}
    \caption{\label{fig:diagrama-pact-django} Diagrama de Pacotes Django}
\end{figure}

\subsubsection{Aplicativo RaDop}\label{aplicativo-radop-2}

A visão lógica do Aplicativo está descrita na Figura 3.

\begin{figure}[!htb]
    \center{\includegraphics[width=\textwidth]{diagrama-pacotes-react.eps}}
